      ...
      >
        ...
        >
          <div id="onboarding-section-0">
            <div
              id="w-node-_6b9b8836-3af6-4010-bb66-611502498a18-958faacb"
              class="w-layout-layout imb-stack wf-layout-layout"
            >
              <div class="w-layout-cell">
                <div
                  id="w-node-_6b9b8836-3af6-4010-bb66-611502498a1a-958faacb"
                  class="w-layout-layout imb-stack wf-layout-layout"
                >
                  <div class="w-layout-cell">
              ...
              <div class="w-layout-cell">
                ...
                >
                  <div class="w-layout-cell">
                    ...
                    <h1 class="imb-typography-light">
                      Welcome to IMB,{" "}
                      <span class="imb-color-primary">John</span>.
                    </h1>
                  </div>
                  <div class="w-layout-cell">
                    <p>
