...
const HiddenShowPage = () => {
  ...
  return (
    <div class="w-layout-blockcontainer imb-container w-container">
      <div id="multistep-container-1" class="imb-multistep w-node-aaf53e66-b55c-b033-c994-da01dce61851-d6793707">
        ...
        <div id="onboarding-section-0">
          <div id="w-node-_6b9b8836-3af6-4010-bb66-611502498a18-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
            <div class="w-layout-cell">
              <div id="w-node-_6b9b8836-3af6-4010-bb66-611502498a1a-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                <div class="w-layout-cell">
        ...
        <div id="onboarding-section-1">
          <div id="w-node-_8d4f01c3-cdbb-cf6b-f671-6c5344d73c32-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
            <div id="w-node-_8d4f01c3-cdbb-cf6b-f671-6c5344d73c35-d6793707" class="w-layout-cell">
              <div id="w-node-_8d4f01c3-cdbb-cf6b-f671-6c5344d73c36-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                <div class="w-layout-cell">
                  ...
                  <div class="w-form">
                    <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="6830281ad50ca3d2d6793707" data-wf-element-id="8d4f01c3-cdbb-cf6b-f671-6c5344d73c3e" data-turnstile-sitekey="0x4AAAAAAAQTptj2So4dx43e" aria-label="Email Form">
                      <div id="onboarding-input-email" class="imb-input">
                        <label for="field" class="imb-input-label">Email</label><input class="imb-input-field w-input" maxlength="256" name="field" data-name="" placeholder="Type something" type="text" id="field" data-type="email"/>
                ...
                <div class="w-layout-cell">
                  <div id="w-node-_8d4f01c3-cdbb-cf6b-f671-6c5344d73c49-d6793707" class="w-layout-layout imb-stack imb-stack-inline wf-layout-layout">
                    <div class="w-layout-cell">
        ...
        <div id="onboarding-section-2">
          <div id="w-node-fbec7a83-5c75-021b-4c22-a03f24af4335-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
            <div id="w-node-fbec7a83-5c75-021b-4c22-a03f24af4338-d6793707" class="w-layout-cell">
              <div id="w-node-fbec7a83-5c75-021b-4c22-a03f24af4339-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                <div class="w-layout-cell">
                  <p class="imb-color-primary-2">Getting Started</p>
                  ...
                  <div class="w-form">
                    <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="6830281ad50ca3d2d6793707" data-wf-element-id="fbec7a83-5c75-021b-4c22-a03f24af4341" data-turnstile-sitekey="0x4AAAAAAAQTptj2So4dx43e" aria-label="Email Form">
                      <div id="onboarding-input-phone" class="imb-input">
                        <label for="field" class="imb-input-label">Phone Number</label><input class="imb-input-field w-input" maxlength="256" name="field" data-name="" placeholder="Type something" type="text" id="field" data-type="email"/>
                ...
                <div class="w-layout-cell">
                  <div id="w-node-fbec7a83-5c75-021b-4c22-a03f24af434c-d6793707" class="w-layout-layout imb-stack imb-stack-inline wf-layout-layout">
                    <div class="w-layout-cell">
        ...
        <div id="onboarding-section-3">
          <div id="w-node-_0b34ad53-4740-686f-8eaf-62f447c35394-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
            <div id="w-node-_0b34ad53-4740-686f-8eaf-62f447c35397-d6793707" class="w-layout-cell">
              <div id="w-node-_0b34ad53-4740-686f-8eaf-62f447c35398-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                <div class="w-layout-cell">
                ...
                <div class="w-layout-cell">
                  <div class="w-form">
                    <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="6830281ad50ca3d2d6793707" data-wf-element-id="0b34ad53-4740-686f-8eaf-62f447c353a0" data-turnstile-sitekey="0x4AAAAAAAQTptj2So4dx43e" aria-label="Email Form">
                      <div id="w-node-_0b34ad53-4740-686f-8eaf-62f447c353a1-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                        <div class="w-layout-cell">
                          <div id="onboarding-input-firstname" class="imb-input">
                            <label for="field" class="imb-input-label">First Name</label><input class="imb-input-field w-input" maxlength="256" name="field" data-name="" placeholder="Type something" type="text" id="field" data-type="email"/>
                            <div class="imb-input-error-message">* First name is required</div>
                          </div>
                        </div>
                        <div class="w-layout-cell">
                          <div id="onboarding-input-middlename" class="imb-input">
                            <label for="field" class="imb-input-label">Middle Name</label><input class="imb-input-field w-input" maxlength="256" name="field" data-name="" placeholder="Type something" type="text" id="field" data-type="email"/>
                            <div class="imb-input-error-message">* Middle name is required</div>
                          </div>
                        </div>
                        <div class="w-layout-cell">
                          <div id="onboarding-input-lastname" class="imb-input">
                            <label for="field" class="imb-input-label">Last Name</label><input class="imb-input-field w-input" maxlength="256" name="field" data-name="" placeholder="Type something" type="text" id="field" data-type="email"/>
                ...
                <div class="w-layout-cell">
                  <div id="w-node-_0b34ad53-4740-686f-8eaf-62f447c353b5-d6793707" class="w-layout-layout imb-stack imb-stack-inline wf-layout-layout">
                    <div class="w-layout-cell">
        ...
        <div id="onboarding-section-4">
          <div id="w-node-f9ecb76b-64dc-778a-c664-5860e8064cf6-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
            <div id="w-node-f9ecb76b-64dc-778a-c664-5860e8064cf7-d6793707" class="w-layout-cell">
              <div id="w-node-f9ecb76b-64dc-778a-c664-5860e8064cf8-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                <div class="w-layout-cell">
                  <p class="imb-color-primary-2">Personal Details</p>
                  <h1 class="imb-typography-light">Let's confirm your details</h1>
                </div>
                <div class="w-layout-cell">
                  <div id="w-node-f9ecb76b-64dc-778a-c664-5860e8064cff-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                    <div class="w-layout-cell">
                ...
                <div class="w-layout-cell">
                  <div id="w-node-f9ecb76b-64dc-778a-c664-5860e8064d0d-d6793707" class="w-layout-layout imb-stack imb-stack-inline wf-layout-layout">
                    <div class="w-layout-cell">
        ...
        <div id="onboarding-section-5">
          <div id="w-node-d063f4b7-329a-6f2d-0599-872182b891cf-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
            <div class="w-layout-cell">
              <div id="w-node-d063f4b7-329a-6f2d-0599-872182b891d1-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                <div class="w-layout-cell">
                ...
                <div class="w-layout-cell">
                  <div id="w-node-d063f4b7-329a-6f2d-0599-872182b891de-d6793707" class="w-layout-layout imb-stack imb-stack-inline wf-layout-layout">
                    <div class="w-layout-cell">
      ...
      <div id="multistep-container-2" class="imb-multistep w-node-c8207f50-3431-cddd-26f6-4ae2a95f2da7-d6793707">
        <div class="imb-stepper">
          <div class="imb-stepper-step">
            <div class="imb-stepper-step-block imb-stepper-step-active"></div>
          </div>
        ...
        <div id="onboarding-section2-0">
          <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2daa-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
            <div class="w-layout-cell">
              <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dac-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                <div class="w-layout-cell">
                  <p class="imb-color-primary">Get Started</p>
                  <h1 class="imb-typography-light">Start your journey with <span class="imb-color-primary">IMB</span> #2.</h1>
                </div>
                <div class="w-layout-cell">
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat. Aenean faucibus nibh et justo cursus id.</p>
                </div>
                <div class="w-layout-cell">
                  <div class="w-layout-grid grid">
                    <div>
                      <div id="onboarding-0-button-login2" class="imb-button imb-button-with-icon">
                        <p class="imb-button-text">Login</p>
                        <img src="https://cdn.prod.website-files.com/681079166d5ce9a9cd684b2c/681ab0b5ef7173dfb95a2ded_arrow.svg" loading="lazy" alt="" class="imb-button-icon"/>
                      </div>
                    </div>
                    <div>
                      <div id="onboarding-0-button-signup2" class="imb-button imb-button-outline">
                        <p class="imb-button-text">Sign up now</p>
                      </div>
                    </div>
                  </div>
        ...
        <div id="onboarding-section2-1">
          <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dc3-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
            <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dc4-d6793707" class="w-layout-cell">
              <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dc5-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                <div class="w-layout-cell">
                  <p class="imb-color-primary-2">Getting Started</p>
                  <h1 class="imb-typography-light">What's your email #2 ?</h1>
                </div>
                <div class="w-layout-cell">
                  <div class="w-form">
                ...
                <div class="w-layout-cell">
                  <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dd8-d6793707" class="w-layout-layout imb-stack imb-stack-inline wf-layout-layout">
                    <div class="w-layout-cell">
                      <div id="onboarding-1-button-back2" class="imb-button imb-button-outline">
                        <p class="imb-button-text">Back</p>
                      </div>
                    </div>
                    <div class="w-layout-cell">
                      <div id="onboarding-1-button-next2" class="imb-button imb-button-with-icon">
                        <p class="imb-button-text">Next</p>
                        <img src="https://cdn.prod.website-files.com/681079166d5ce9a9cd684b2c/681ab0b5ef7173dfb95a2ded_arrow.svg" loading="lazy" alt="" class="imb-button-icon"/>
                      </div>
                    </div>
        ...
        <div id="onboarding-section2-2">
          <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dfd-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
            <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dfe-d6793707" class="w-layout-cell">
              <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dff-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                <div class="w-layout-cell">
                  <p class="imb-color-primary-2">Personal Details</p>
                  <h1 class="imb-typography-light">Let's get to know you #2</h1>
                </div>
                <div class="w-layout-cell">
                  <div class="w-form">
                    <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="6830281ad50ca3d2d6793707" data-wf-element-id="c8207f50-3431-cddd-26f6-4ae2a95f2e07" data-turnstile-sitekey="0x4AAAAAAAQTptj2So4dx43e" aria-label="Email Form">
                      <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2e08-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                        <div class="w-layout-cell">
                          <div id="onboarding-input-firstname" class="imb-input">
                            <label for="field" class="imb-input-label">First Name</label><input class="imb-input-field w-input" maxlength="256" name="field" data-name="" placeholder="Type something" type="text" id="field" data-type="email"/>
                            <div class="imb-input-error-message">* First name is required</div>
                ...
                <div class="w-layout-cell">
                  <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2e1c-d6793707" class="w-layout-layout imb-stack imb-stack-inline wf-layout-layout">
                    <div class="w-layout-cell">
                      <div id="onboarding-2-button-back2" class="imb-button imb-button-outline">
                        <p class="imb-button-text">Back</p>
                      </div>
                    </div>
                    <div class="w-layout-cell">
                      <div id="onboarding-2-button-next2" class="imb-button imb-button-with-icon">
                        <p class="imb-button-text">Next</p>
                        <img src="https://cdn.prod.website-files.com/681079166d5ce9a9cd684b2c/681ab0b5ef7173dfb95a2ded_arrow.svg" loading="lazy" alt="" class="imb-button-icon"/>
                      </div>
                    </div>
        ...
        <div id="onboarding-section2-3">
          <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2e43-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
            <div class="w-layout-cell">
              <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2e45-d6793707" class="w-layout-layout imb-stack wf-layout-layout">
                <div class="w-layout-cell">
                  <p class="imb-color-primary">Success</p>
                  <h1 class="imb-typography-light">Welcome to IMB, <span class="imb-color-primary">John</span> #2.</h1>
                </div>
                <div class="w-layout-cell">
                  <p>Congratulations on opening your account with us! We're thrilled to have you as a part of our community. We make banking a breeze at IMB. Feel free to reach out here if you have any questions or need assistance.</p>
                </div>
                <div class="w-layout-cell">
                  <div id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2e52-d6793707" class="w-layout-layout imb-stack imb-stack-inline wf-layout-layout">
                    <div class="w-layout-cell">
                      <div id="onboarding-success-button-begin2" class="imb-button imb-button-with-icon">
                        <p class="imb-button-text">Let's Begin</p>
                        <img src="https://cdn.prod.website-files.com/681079166d5ce9a9cd684b2c/681ab0b5ef7173dfb95a2ded_arrow.svg" loading="lazy" alt="" class="imb-button-icon"/>
                      </div>
                    </div>
                    <div class="w-layout-cell">
                      <div id="onboarding-success-button-getapp2" class="imb-button imb-button-outline">
                        <p class="imb-button-text">Get the App</p>
                      </div>
                    </div>
                  </div>
