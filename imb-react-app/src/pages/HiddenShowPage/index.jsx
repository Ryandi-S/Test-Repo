  ...
  return (
    <div className="w-layout-blockcontainer imb-container w-container">
      <div
        ...
        className="imb-multistep w-node-aaf53e66-b55c-b033-c994-da01dce61851-d6793707"
      >
              ...
              >
                ...
                <div className="w-layout-cell">
                  <p>
                    ...
                    banking a breeze at IMB. Feel free to reach out here if you
      ...
      <div
        id="multistep-container-2"
        className="imb-multistep w-node-c8207f50-3431-cddd-26f6-4ae2a95f2da7-d6793707"
      >
        <div className="imb-stepper">
          <div className="imb-stepper-step">
            <div className="imb-stepper-step-block imb-stepper-step-active"></div>
        ...
        <div id="onboarding-section2-0">
          <div
            id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2daa-d6793707"
            className="w-layout-layout imb-stack wf-layout-layout"
          >
            <div className="w-layout-cell">
              <div
                id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dac-d6793707"
                className="w-layout-layout imb-stack wf-layout-layout"
              >
                <div className="w-layout-cell">
                  <p className="imb-color-primary">Get Started</p>
                  <h1 className="imb-typography-light">
                    Start your journey with{" "}
                    <span className="imb-color-primary">IMB</span> #2.
                  </h1>
                </div>
                <div className="w-layout-cell">
                  <p>
                ...
                <div className="w-layout-cell">
                  <div className="w-layout-grid grid">
                    ...
                    <div>
                      <div
                        id="onboarding-0-button-signup2"
                        className="imb-button imb-button-outline"
                      >
                        <p className="imb-button-text">Sign up now</p>
                      </div>
        ...
        <div id="onboarding-section2-1">
          <div
            id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dc3-d6793707"
            className="w-layout-layout imb-stack wf-layout-layout"
          >
            <div
              id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dc4-d6793707"
              className="w-layout-cell"
            >
              <div
                id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dc5-d6793707"
                className="w-layout-layout imb-stack wf-layout-layout"
              >
                <div className="w-layout-cell">
                  <p className="imb-color-primary-2">Getting Started</p>
                ...
                <div className="w-layout-cell">
                  <div className="w-form">
                    <form
                      ...
                      method="get"
                      data-wf-page-id="6830281ad50ca3d2d6793707"
                      data-wf-element-id="c8207f50-3431-cddd-26f6-4ae2a95f2dcd"
                      data-turnstile-sitekey="0x4AAAAAAAQTptj2So4dx43e"
                      aria-label="Email Form"
                    >
                      <div id="onboarding-input-email" className="imb-input">
                ...
                <div className="w-layout-cell">
                  <div
                    id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dd8-d6793707"
                    className="w-layout-layout imb-stack imb-stack-inline wf-layout-layout"
                  >
                    <div className="w-layout-cell">
                      <div
                        id="onboarding-1-button-back2"
                        className="imb-button imb-button-outline"
                      >
                        <p className="imb-button-text">Back</p>
                      </div>
        ...
        <div id="onboarding-section2-2">
          <div
            id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dfd-d6793707"
            className="w-layout-layout imb-stack wf-layout-layout"
          >
            <div
              id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dfe-d6793707"
              className="w-layout-cell"
            >
              <div
                id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2dff-d6793707"
                className="w-layout-layout imb-stack wf-layout-layout"
              >
                <div className="w-layout-cell">
                  <p className="imb-color-primary-2">Personal Details</p>
                  <h1 className="imb-typography-light">
                    Let's get to know you #2
                  </h1>
                </div>
                <div className="w-layout-cell">
                  <div className="w-form">
                    <form
                      ...
                      method="get"
                      data-wf-page-id="6830281ad50ca3d2d6793707"
                      data-wf-element-id="c8207f50-3431-cddd-26f6-4ae2a95f2e07"
                      data-turnstile-sitekey="0x4AAAAAAAQTptj2So4dx43e"
                      aria-label="Email Form"
                    >
                      <div
                        id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2e08-d6793707"
                        className="w-layout-layout imb-stack wf-layout-layout"
                      >
                        <div className="w-layout-cell">
                          <div
                ...
                <div className="w-layout-cell">
                  <div
                    id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2e1c-d6793707"
                    className="w-layout-layout imb-stack imb-stack-inline wf-layout-layout"
                  >
                    <div className="w-layout-cell">
                      <div
                        id="onboarding-2-button-back2"
                        className="imb-button imb-button-outline"
                      >
                        <p className="imb-button-text">Back</p>
                      </div>
        ...
        <div id="onboarding-section2-3">
          <div
            id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2e43-d6793707"
            className="w-layout-layout imb-stack wf-layout-layout"
          >
            <div className="w-layout-cell">
              <div
                id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2e45-d6793707"
                className="w-layout-layout imb-stack wf-layout-layout"
              >
                <div className="w-layout-cell">
                  <p className="imb-color-primary">Success</p>
                  <h1 className="imb-typography-light">
                    Welcome to IMB,{" "}
                    <span className="imb-color-primary">John</span> #2.
                  </h1>
                </div>
                <div className="w-layout-cell">
                  <p>
                ...
                <div className="w-layout-cell">
                  <div
                    id="w-node-c8207f50-3431-cddd-26f6-4ae2a95f2e52-d6793707"
                    className="w-layout-layout imb-stack imb-stack-inline wf-layout-layout"
                  >
                    <div className="w-layout-cell">
                      <div
                        id="onboarding-success-button-begin2"
                        className="imb-button imb-button-with-icon"
                      >
                        <p className="imb-button-text">Let's Begin</p>
                        <img
                    ...
                    <div className="w-layout-cell">
                      <div
                        id="onboarding-success-button-getapp2"
                        className="imb-button imb-button-outline"
                      >
                        <p className="imb-button-text">Get the App</p>
                      </div>
