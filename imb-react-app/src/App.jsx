...
import PersonalDetailsConfirmPage from "./pages/PersonalDetailConfirmPage";
import SuccessPage from "./pages/SuccessPage"; // Removed invalid syntax
import HiddenShowPage from "./pages/HiddenShowPage";
// import { mapPageToStep } from "./utils/mapPageToStep";
...
function App() {
  ...
  // return (
  //   <div className="flex flex-col items-left mx-auto md:px-40 px-6 max-w-[1440px] w-full h-[calc(100vh-64px)] overflow-auto no-scrollbar justify-start 2xl:justify-center">
  //     {page < 4 && page !== 0 && (
